/**
 * Minimal hand-rolled RFC6455 WebSocket server for the browsr bridge.
 *
...
export const BROWSR_PORT = Number(process.env.BROWSR_PORT || 8757);
 ...
 *
 * @param {object} opts
 * @param {number} [opts.port=BROWSR_PORT] 0 picks an ephemeral port
 ...
 */
export function startBridgeServer({ port = BROWSR_PORT, onClientMessage, onClientState }) {
